...
const API_URL = "https://beers-api.edu.ironhack.com/beers/new";
...
function AddBeerPage() {
  ...
  // Handle the form submission and send the form data to the Beers API to create a new beer.
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .catch((error) => {
        console.log("Error creating the new beer", error);
      });
  };
